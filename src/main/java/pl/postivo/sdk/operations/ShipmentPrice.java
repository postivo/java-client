...
public class ShipmentPrice {
    ...
    public static class Sync extends Base
            implements RequestOperation<Shipment, ShipmentPriceResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public ShipmentPriceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ShipmentPriceResponse.Builder resBuilder =
            ...
            ShipmentPriceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<pl.postivo.sdk.models.components.ShipmentPrice> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withShipmentPrices(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Shipment, pl.postivo.sdk.models.operations.async.ShipmentPriceResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ShipmentPriceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ShipmentPriceResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ShipmentPriceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ShipmentPriceResponse res = resBuilder.build();
