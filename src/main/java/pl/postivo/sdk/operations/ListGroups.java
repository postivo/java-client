...
public class ListGroups {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListGroupsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGroupsResponse.Builder resBuilder =
                    ListGroupsResponse
                            .builder()
            ...
            ListGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<GroupResponse> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGroupResponses(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.postivo.sdk.models.operations.async.ListGroupsResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ListGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ListGroupsResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ListGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ListGroupsResponse res = resBuilder.build();
