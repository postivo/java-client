...
public class AddContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<Contact, AddContactResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Contact request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Contact>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Contact request) throws Exception {
        ...
        @Override
        public AddContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddContactResponse.Builder resBuilder =
                    AddContactResponse
                            .builder()
            ...
            AddContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Contact, pl.postivo.sdk.models.operations.async.AddContactResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Contact request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Contact>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Contact request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.AddContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.AddContactResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.AddContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.AddContactResponse res = resBuilder.build();
