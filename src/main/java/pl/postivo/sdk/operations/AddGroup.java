...
public class AddGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<Group, AddGroupResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Group request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Group>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Group request) throws Exception {
        ...
        @Override
        public AddGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddGroupResponse.Builder resBuilder =
                    AddGroupResponse
                            .builder()
            ...
            AddGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Group, pl.postivo.sdk.models.operations.async.AddGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Group request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Group>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Group request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.AddGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.AddGroupResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.AddGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.AddGroupResponse res = resBuilder.build();
