...
public class DeleteSender {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSenderRequest, DeleteSenderResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSenderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSenderRequest.class);
        ...
        public DeleteSenderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            DeleteSenderResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSenderRequest, pl.postivo.sdk.models.operations.async.DeleteSenderResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.DeleteSenderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.DeleteSenderResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.DeleteSenderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.DeleteSenderResponse res = resBuilder.build();
