...
public class ListMetadata {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListMetadataResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListMetadataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMetadataResponse.Builder resBuilder =
            ...
            ListMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MetadataResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMetadataResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.postivo.sdk.models.operations.async.ListMetadataResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ListMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ListMetadataResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ListMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ListMetadataResponse res = resBuilder.build();
