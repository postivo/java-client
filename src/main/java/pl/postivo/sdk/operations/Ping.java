...
public class Ping {
            ...
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "4XX", "503", "5XX")) {
        ...
        public PingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    pl.postivo.sdk.models.components.PingResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPingResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.postivo.sdk.models.operations.async.PingResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest() {
            ...
            return retries.retry(() -> Exceptions.unchecked(() -> onBuildRequest()).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "400", "4XX", "503", "5XX")) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.PingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.PingResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.PingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.PingResponse res = resBuilder.build();
