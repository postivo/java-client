...
public class AddContactByExtIdToGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddContactByExtIdToGroupRequest, AddContactByExtIdToGroupResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddContactByExtIdToGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddContactByExtIdToGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddContactByExtIdToGroupRequest request) throws Exception {
        ...
        @Override
        public AddContactByExtIdToGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddContactByExtIdToGroupResponse.Builder resBuilder =
            ...
            AddContactByExtIdToGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddContactByExtIdToGroupRequest, pl.postivo.sdk.models.operations.async.AddContactByExtIdToGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddContactByExtIdToGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddContactByExtIdToGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddContactByExtIdToGroupRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.AddContactByExtIdToGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.AddContactByExtIdToGroupResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.AddContactByExtIdToGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.AddContactByExtIdToGroupResponse res = resBuilder.build();
