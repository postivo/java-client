...
public class DeleteContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteContactRequest, DeleteContactResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteContactRequest request) throws Exception {
        ...
        @Override
        public DeleteContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteContactResponse.Builder resBuilder =
            ...
            DeleteContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteContactRequest, pl.postivo.sdk.models.operations.async.DeleteContactResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteContactRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.DeleteContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.DeleteContactResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.DeleteContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.DeleteContactResponse res = resBuilder.build();
