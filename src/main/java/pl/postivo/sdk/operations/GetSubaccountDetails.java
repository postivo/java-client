...
public class GetSubaccountDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSubaccountDetailsRequest, GetSubaccountDetailsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSubaccountDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSubaccountDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSubaccountDetailsRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "4XX", "5XX")) {
        ...
        @Override
        public GetSubaccountDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSubaccountDetailsResponse.Builder resBuilder =
            ...
            GetSubaccountDetailsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSubaccountDetailsRequest, pl.postivo.sdk.models.operations.async.GetSubaccountDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSubaccountDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSubaccountDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSubaccountDetailsRequest request) {
            ...
            return retries.retry(() -> Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "401", "403", "404", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.GetSubaccountDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.GetSubaccountDetailsResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.GetSubaccountDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.GetSubaccountDetailsResponse res = resBuilder.build();
