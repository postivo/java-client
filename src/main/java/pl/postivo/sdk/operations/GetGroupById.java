...
public class GetGroupById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGroupByIdRequest, GetGroupByIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetGroupByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGroupByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGroupByIdRequest request) throws Exception {
        ...
        @Override
        public GetGroupByIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGroupByIdResponse.Builder resBuilder =
            ...
            GetGroupByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GroupResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGroupResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGroupByIdRequest, pl.postivo.sdk.models.operations.async.GetGroupByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetGroupByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGroupByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGroupByIdRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.GetGroupByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.GetGroupByIdResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.GetGroupByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.GetGroupByIdResponse res = resBuilder.build();
