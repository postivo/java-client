...
public class ListSenders {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListSendersResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListSendersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSendersResponse.Builder resBuilder =
                    ListSendersResponse
                            .builder()
            ...
            ListSendersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<SenderDetails> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.postivo.sdk.models.operations.async.ListSendersResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ListSendersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ListSendersResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ListSendersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ListSendersResponse res = resBuilder.build();
