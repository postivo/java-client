...
public class AddContactToGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddContactToGroupRequest, AddContactToGroupResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddContactToGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddContactToGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddContactToGroupRequest request) throws Exception {
        ...
        @Override
        public AddContactToGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddContactToGroupResponse.Builder resBuilder =
            ...
            AddContactToGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddContactToGroupRequest, pl.postivo.sdk.models.operations.async.AddContactToGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddContactToGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddContactToGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddContactToGroupRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.AddContactToGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.AddContactToGroupResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.AddContactToGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.AddContactToGroupResponse res = resBuilder.build();
