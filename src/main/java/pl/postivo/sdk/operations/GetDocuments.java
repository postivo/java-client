...
public class GetDocuments {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDocumentsRequest request) throws Exception {
        ...
        @Override
        public GetDocumentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDocumentsResponse.Builder resBuilder =
            ...
            GetDocumentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DocumentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDocumentResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDocumentsRequest, pl.postivo.sdk.models.operations.async.GetDocumentsResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.GetDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.GetDocumentsResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.GetDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.GetDocumentsResponse res = resBuilder.build();
