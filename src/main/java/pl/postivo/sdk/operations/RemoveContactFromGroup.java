...
public class RemoveContactFromGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveContactFromGroupRequest, RemoveContactFromGroupResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveContactFromGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveContactFromGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveContactFromGroupRequest request) throws Exception {
        ...
        @Override
        public RemoveContactFromGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveContactFromGroupResponse.Builder resBuilder =
            ...
            RemoveContactFromGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveContactFromGroupRequest, pl.postivo.sdk.models.operations.async.RemoveContactFromGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveContactFromGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveContactFromGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveContactFromGroupRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.RemoveContactFromGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.RemoveContactFromGroupResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.RemoveContactFromGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.RemoveContactFromGroupResponse res = resBuilder.build();
