...
public class VerifySender {
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifySenderRequest, VerifySenderResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VerifySenderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VerifySenderRequest.class, new TypeReference<VerifySenderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifySenderRequest request) throws Exception {
        ...
        @Override
        public VerifySenderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifySenderResponse.Builder resBuilder =
            ...
            VerifySenderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VerifySenderRequest, pl.postivo.sdk.models.operations.async.VerifySenderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VerifySenderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VerifySenderRequest.class, new TypeReference<VerifySenderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VerifySenderRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.VerifySenderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.VerifySenderResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.VerifySenderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.VerifySenderResponse res = resBuilder.build();
