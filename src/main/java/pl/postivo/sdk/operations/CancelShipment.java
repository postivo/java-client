...
public class CancelShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelShipmentRequest, CancelShipmentResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelShipmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelShipmentRequest request) throws Exception {
        ...
        @Override
        public CancelShipmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelShipmentResponse.Builder resBuilder =
            ...
            CancelShipmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ShipmentCancellation> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withShipmentCancellations(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelShipmentRequest, pl.postivo.sdk.models.operations.async.CancelShipmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelShipmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelShipmentRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.CancelShipmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.CancelShipmentResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.CancelShipmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.CancelShipmentResponse res = resBuilder.build();
