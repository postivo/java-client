...
public class GetAccountDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.postivo.sdk.models.operations.async.GetAccountDetailsResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.GetAccountDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.GetAccountDetailsResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.GetAccountDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.GetAccountDetailsResponse res = resBuilder.build();
