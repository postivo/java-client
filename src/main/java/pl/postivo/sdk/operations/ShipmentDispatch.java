...
public class ShipmentDispatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<Shipment, ShipmentDispatchResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(Shipment request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Shipment>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Shipment request) throws Exception {
        ...
        @Override
        public ShipmentDispatchResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ShipmentDispatchResponse.Builder resBuilder =
            ...
            ShipmentDispatchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ShipmentDetails> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withShipmentDetails(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Shipment, pl.postivo.sdk.models.operations.async.ShipmentDispatchResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Shipment request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Shipment>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Shipment request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ShipmentDispatchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ShipmentDispatchResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ShipmentDispatchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ShipmentDispatchResponse res = resBuilder.build();
