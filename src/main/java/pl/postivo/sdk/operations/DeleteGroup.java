...
public class DeleteGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteGroupRequest, DeleteGroupResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteGroupRequest.class);
        ...
        @Override
        public DeleteGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteGroupResponse.Builder resBuilder =
                    DeleteGroupResponse
                            .builder()
            ...
            DeleteGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteGroupRequest, pl.postivo.sdk.models.operations.async.DeleteGroupResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.DeleteGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.DeleteGroupResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.DeleteGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.DeleteGroupResponse res = resBuilder.build();
