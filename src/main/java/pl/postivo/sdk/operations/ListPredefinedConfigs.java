...
public class ListPredefinedConfigs {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListPredefinedConfigsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListPredefinedConfigsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPredefinedConfigsResponse.Builder resBuilder =
            ...
            ListPredefinedConfigsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<PredefinedConfig> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPredefinedConfigs(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.postivo.sdk.models.operations.async.ListPredefinedConfigsResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ListPredefinedConfigsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ListPredefinedConfigsResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ListPredefinedConfigsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ListPredefinedConfigsResponse res = resBuilder.build();
