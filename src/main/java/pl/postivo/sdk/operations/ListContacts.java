...
public class ListContacts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListContactsRequest request) throws Exception {
        ...
        @Override
        public ListContactsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ContactResponse> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContactResponses(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListContactsRequest, pl.postivo.sdk.models.operations.async.ListContactsResponse> {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.ListContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.ListContactsResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.ListContactsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.ListContactsResponse res = resBuilder.build();
