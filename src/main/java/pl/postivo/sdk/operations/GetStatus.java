...
public class GetStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStatusRequest, GetStatusResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStatusRequest request) throws Exception {
        ...
        @Override
        public GetStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStatusResponse.Builder resBuilder =
                    GetStatusResponse
                            .builder()
            ...
            GetStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<StatusDetails> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withStatusDetails(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStatusRequest, pl.postivo.sdk.models.operations.async.GetStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStatusRequest request) {
        ...
        @Override
        public CompletableFuture<pl.postivo.sdk.models.operations.async.GetStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.postivo.sdk.models.operations.async.GetStatusResponse.Builder resBuilder =
                    pl.postivo.sdk.models.operations.async.GetStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.postivo.sdk.models.operations.async.GetStatusResponse res = resBuilder.build();
