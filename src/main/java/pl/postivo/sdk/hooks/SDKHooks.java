...
public final class SDKHooks {
    ...
    public static void initialize(pl.postivo.sdk.utils.Hooks hooks) {
    ...
    public static void initialize(pl.postivo.sdk.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(pl.postivo.sdk.utils.HookAdapters.adapt(mySyncHook));
